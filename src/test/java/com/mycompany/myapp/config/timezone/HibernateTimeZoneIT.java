...
class HibernateTimeZoneIT {
    ...
    public void setup() {
        ...
        dateTimeWrapper.setLocalDate(LocalDate.parse("2014-11-12T05:50:00.0Z"));
    ...
    @Test
    @Transactional
    void storeLocalDateWithZoneIdConfigShouldBeStoredOnGMTTimeZone() {
        dateTimeWrapperRepository.saveAndFlush(dateTimeWrapper);

        String request = generateSqlRequest("LocalDate", dateTimeWrapper.getId());
        SqlRowSet resultSet = jdbcTemplate.queryForRowSet(request);
        String expectedValue = dateTimeFormatter.format(dateTimeWrapper.getLocalDate());

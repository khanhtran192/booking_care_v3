    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="bookingCareV3App.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="description">
              <Translate contentKey="bookingCareV3App.department.description">Description</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.description}</dd>
          <dt>
            <Translate contentKey="bookingCareV3App.department.hospital">Hospital</Translate>
          </dt>
